...
export default function QrCard({ innerBgClass, firstName, lastName }: Props) {
  return (
    <div className="bg-[#D5F334] w-full h-full rounded-b-3xl lg:rounded-b-none">
      {/* Replace 'bg-black' with the dynamic prop */}
      <div
        className={`${innerBgClass} w-full h-[76%] p-6 lg:p-12 rounded-b-[50px] lg:rounded-b-[85px] transition-colors duration-500`}
      >
        <div className="flex items-start w-full flex-col">
          ...
          <div className="w-full items-center flex flex-col gap-2 lg:gap-4">
            <Image
              src="/qr2.png"
              width={200}
              height={200}
              alt="QR Code"
              className="w-32 lg:w-100"
            />
      ...
      <div className="py-6 lg:py-10 px-4 lg:px-8 flex items-end justify-between">
        <div className="flex flex-col items-start">
          <p className="text-2xl lg:text-3xl font-bold text-black">{firstName}</p>
